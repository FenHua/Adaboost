function[Learners,Weights,final_hyp]=RealAdaBoost(WeakLrn,Data,Labels,Max_Iter,OldLrn,final_hyp)
if(nargin==4)
    Learners={};
    Weights=[];
...
elseif(nargin>5)
    ...
    error('Function takes either 4 or 6 arguments');
end
for It=1:Max_Iter
    %choose the best learner
